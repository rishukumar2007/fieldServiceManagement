...
public class AuthControllerTest {
    ...
    void testSuccessfulLogin() throws Exception {
        LoginRequest request = new LoginRequest("john.m@meridian.com", "password123");
        ...
        mockMvc.perform(post("/auth/login")
                ...
                .andExpect(jsonPath("$.user.email").value("john.m@meridian.com"))
                .andExpect(jsonPath("$.user.role").value("MANAGER"));
    }

    @Test
    void testFailedLoginInvalidPassword() throws Exception {
        LoginRequest request = new LoginRequest("john.m@meridian.com", "wrongpassword");
